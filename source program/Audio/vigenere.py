...
if __name__ == '__main__':
    ...
    with open("insta.png", "rb") as file:
        inp = base64.b64encode(file.read()).decode('utf-8')  # Encode ke base64 string

    # Enkripsi string base64
    ct = cipher.encrypt(inp)

    # Dekripsi kembali ke string base64
    pt = cipher.decrypt(ct)

    # Decode base64 kembali ke data biner
    decoded_data = base64.b64decode(pt)

    # Simpan data hasil dekripsi sebagai file gambar
    with open('insta2.png', 'wb') as file2:
        file2.write(decoded_data)